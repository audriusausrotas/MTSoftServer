...
const defaultValuesSchema = new mongoose.Schema<DefaultValues>({
  ...
  retailBindingsEco: { type: String, required: false, default: "" },
  retailDoubleLegEco: { type: String, required: false, default: "" },
  retailSingleLegEco: { type: String, required: false, default: "" },
